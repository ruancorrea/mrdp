...
class GreedyUniqueStrategy(UniqueStrategy):
    ...
    def generate_solution(
            ...
            for delivery_id in unassigned_deliveries:
                ...
                for vehicle in vehicles:
                    ...
                    if current_route_indices:
                        eval_res = self.evaluate.evaluate_sequence(current_route_indices, time_matrix, p_min, t_min, depot_index=depot_idx)
                    ...
                    for i in range(len(current_route_indices) + 1):
                        ...
                        eval_res = self.evaluate.evaluate_sequence(temp_route, time_matrix, p_min, t_min, depot_index=depot_idx)
        ...
        for vehicle_id, route_ids in routes.items():
            ...
            final_eval = self.evaluate.evaluate_sequence(route_indices, time_matrix, p_min, t_min, depot_index=depot_idx)
