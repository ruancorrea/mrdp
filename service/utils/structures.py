...
from service.utils.enums import OrderStatus, EventType, VehicleStatus
...
class Delivery:
    ...
    # Fields to be populated during simulation
    dispatch_time: Optional[datetime] = field(default=None, compare=False, hash=False)
    completion_time: Optional[datetime] = field(default=None, compare=False, hash=False)
